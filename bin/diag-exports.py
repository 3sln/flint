...
EXPORTS = [
    ...
    "stat_alloc_by_ty", "stat_alloc_gas_by_ty",
    ...
    "set_gc_watch_end", "stat_end_bump", "stat_origin", "stat_origin_seq", "stat_stale_set", "stat_stale_root", "stat_stale_shadow", "stat_stale_push", "stat_region", "stat_static", "stat_native_trace", "stat_flattens", "stat_restore_stale", "set_gc_origin_window", "stat_native_slot", "stat_native_name",
]
