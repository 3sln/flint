...
EXPORTS = [
    ...
    "set_gc_watch_end", "stat_end_bump", "stat_origin", "stat_origin_seq", "stat_park_rooted", "stat_watch_hit", "stat_stale_write", "stat_stale_cmp", "stat_stale_set", "stat_stale_root", "stat_stale_shadow", "stat_restore_stale", "set_gc_origin_window", "stat_native_slot", "stat_native_name",
]
