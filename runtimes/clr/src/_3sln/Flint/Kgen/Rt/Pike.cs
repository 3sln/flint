...
public static class Pike {
    ...
    public static bool ClassHit(int[] prog, int classBase, int off, int v) {
    ...
    public static bool Consumes(int[] prog, int codeBase, int classBase, int pc, int v) {
        int b = codeBase + (pc * 3);
        int op = prog[b];
        if (op == 0) {
            return v == prog[b + 1];
    ...
    public static int AddThread(int[] prog, int codeBase, int[] cps, int cpsLen, int i, int[] mem, int listAt, int n, bool[] seen, int pc, int scratchAt, int savedAt, int nslots) {
        if (seen[pc]) {
            return n;
        }
        seen[pc] = true;
        ...
        if ((op == 8) || (op == 9)) {
            ...
            bool after = (i < cpsLen) && WordCp(cps[i]);
    ...
    public static bool RunOver(int[] prog, int ninstrs, int nslots, int[] cps, int cpsLen, int from, int entry, bool full, int[] mem, int aAt, int bAt, int scratchAt, int startAt, int bestAt, bool[] seen) {
        if (from > cpsLen) {
            return false;
        }
