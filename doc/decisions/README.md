...
0. **Virtual namespaces** (`0036` steps 4–6) — now the blocker for `0037` as
   well as for pods, since every namespace in that file is a virtual one — the
