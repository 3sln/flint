...
| `deps.edn` support: git/npm/maven at exact versions | done | `cli` — **maven's transitive resolution is explicitly cancelled**, on a measured survey (8.9% of a 135-namespace Clojars sample compiles cleanly on flint; transitive resolution would fix ~2 of 135) |
